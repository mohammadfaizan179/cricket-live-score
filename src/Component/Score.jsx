...
class Score extends Component {
    ...
    //     ans.second = num[2] && numid[1]  && numid[1].replace(/[^0-9]/g, "") + "/" + numid[2].replace(/[^0-9]/g, "");
    //     return ans;
    // }
    render() {
            ...
            <div className="score_body">
                <Card elevation={10} className="card_wraper">
                        <Box className={this.props.classes.scoreCardHeader}>
                            ...
                            <Button color="secondary" size="small" style={{marginLeft: "auto", color: "#fff", border: "2px solid #fff"}} onClick={()=> this.getScore(this.props.match.unique_id)} disabled={this.props.match.matchStarted ? false : true}>Get Score</Button>
                        </Box>
                        <CardContent>
